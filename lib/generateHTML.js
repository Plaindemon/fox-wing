...
<div class="card-body">    
      <p class="subheader">Employee Name: ${managerList[i].name}</p>
      <p>Employee Id: ${managerList[i].id}</p>
      <a href="mailto:${managerList[i].email}"> Email Address: ${managerList[i].email}</a>
      
      <p>Office Id Number: ${managerList[i].office}</p>
      </div> 
    </div>
  `
    }
  ...
  //   })
    ...
    for (var i = 0; i < internList.length; i++) {
      ...
      <div class="card-header">
            ...
            <p class="subheader">Employee Name: ${internList[i].name}</p>
            <p>Employee Id: ${internList[i].id}</p>
            <a href="mailto:${internList[i].email}">Email Address: ${internList[i].email}</a>
            <p>School Id: ${internList[i].school}</p>
            </div> 
              </div>
            `
    }
    for (var i = 0; i < engineerList.length; i++) {
      ...
      <p class="subheader"> Engineer Name:${engineerList[i].name}</p>
      <p>Employee Id:${engineerList[i].id}</p>
      <a href="mailto:${engineerList[i].email}">Email Address:${engineerList[i].email}</a>
      <br>
